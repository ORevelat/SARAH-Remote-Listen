...
module.exports = function(RED) {
    ...
    RED.nodes.registerType("win-sarah-remote", register, {});

    // Register for button callback
    RED.httpAdmin.post("/win-sarah-remote/:id/:state", RED.auth.needsPermission("win-sarah-remote.write"), function(req,res) {
